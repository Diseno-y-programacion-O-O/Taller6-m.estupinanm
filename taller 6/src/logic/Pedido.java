...
public class Pedido {
	...
	public Pedido(String nombreCliente, String direccionCliente, int numeroPedidos, int valorTotal) {
	...
	public void agregarProducto(Producto nuevoItem) throws ValorTotalExcedido {
		int nuevoValorTotal = valorTotal + nuevoItem.getPrecio();
	
		if (nuevoValorTotal > 150000) {
			throw new ValorTotalExcedido(nuevoValorTotal);
		}
	
		productos.add(nuevoItem);
		valorTotal = nuevoValorTotal;
		System.out.println("\nSe agregó " + nuevoItem.getNombre() + " al pedido");
	}
